...
export default (scope: Construct): ManagedDomain => {
	...
	managedDomain
		...
		.addCNameRecord(
			"wixdkim2",
			"s1._domainkey",
			"s1._domainkey.rawkode.academy.s011.ascendbywix.com",
		)
		.addCNameRecord(
			"wixdkim3",
			"s2._domainkey",
			"s2._domainkey.rawkode.academy.s011.ascendbywix.com",
		)
		.addCNameRecord(
			"wixdkim4",
			"sel1._domainkey",
			"sel1._domainkey.rawkode.academy.s011.ascendbywix.com",
		)
		.addTextRecord(
			"_atproto",
			"_atproto",
