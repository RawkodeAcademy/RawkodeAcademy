episode "klustered-klustered-14" {
  title = "Klustered #14"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-06-10T16:00:00Z"
  youtube_id = "5Rw7_1Yvm0U"
  youtube_category = 24
  links = [
  ...
  chapter "Cluster 31 by Arian van Putten (@ProgrammerDude)" {
    time = "00:03:55"
  }

  chapter "Cluster 32 by Sid Palas (@sidpalas)" {
    time = "00:53:00"
  }
}
