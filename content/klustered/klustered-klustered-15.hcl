episode "klustered-klustered-15" {
  title = "Klustered #15"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-07-01T16:30:00Z"
  youtube_id = "4lMxlQ64Z7I"
  youtube_category = 24
  links = [
    ...
    "https://github.com/Klaven",
    "https://twitter.com/boredabdel",
    "https://github.com/boredabdel"
  ]
  ...
  chapter "Cluster 33 by Marek Counts (@TheNullChannel)" {
    time = "00:03:30"
  }

  chapter "Cluster 34 by Abdel Sghiouar (@boredabdel)" {
    time = "00:51:00"
  }
}
