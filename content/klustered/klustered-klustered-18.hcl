episode "klustered-klustered-18" {
  title = "Klustered #18"
  draft = false
  show = "klustered"
  live = true
  ...
  links = [
    ...
    "https://twitter.com/ericsmalling",
    "https://github.com/ericsmalling",
    "https://twitter.com/csantanapr",
  ...
  chapter "Cluster by Eric Smalling" {
    time = "00:04:00"
  }

  chapter "Cluster by Carlos Santana" {
    time = "00:30:00"
  }
}
