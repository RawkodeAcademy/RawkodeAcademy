episode "klustered-klustered-part-vi" {
  ...
  chapter "Cluster 011, Broken by @SaiyamPathak" {
    time = "00:04:50"
  }

  chapter "Cluster 013, Broken by @thebsdbox and @dtiber" {
    time = "01:12:00"
  }
}
