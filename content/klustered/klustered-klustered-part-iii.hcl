episode "klustered-klustered-part-iii" {
  title = "Klustered (Part III)"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-03-04T17:00:00Z"
  ...
  chapter "Kluster 003 by Justin Garrison" {
    time = "00:03:40"
  }

  chapter "Kluster 006 by SIG Honk (Ian Coldwater, Duffie Cooley, Rory McCune, Brad Geesaman)" {
    time = "00:48:00"
  }
}
