episode "rawkode-live-hands-on-introduction-to-firecracker" {
  ...
  chapter "What is Firecracker?" {
    time = "00:02:45"
  }

  chapter "Installing Firecracker" {
    time = "00:06:30"
  }

  chapter "Running a Firecracker microVM" {
    time = "00:12:30"
  }

  chapter "Feature Demo: Snapshots" {
    time = "00:34:00"
  }
