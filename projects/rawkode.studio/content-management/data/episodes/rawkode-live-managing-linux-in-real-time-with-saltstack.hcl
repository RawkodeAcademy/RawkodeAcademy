episode "Managing Linux in Real Time with SaltStack" {
  ...
  chapters = [
    ...
    {
      "time" = "00:05:00"
      "title" = "Deploying a heterogeneous cluster (Machines and OS) with SaltStack on Packet’s bare metal with Pulumi and TypeScript"
    },
    {
      "time" = "00:17:30"
    ...
    {
      "time" = "00:24:00"
      "title" = "Ed has a cool use-case for Tailscale, connecting his SaltStack nodes over disparate private networks"
    },
    {
      "time" = "00:26:30"
    ...
    {
      "time" = "00:29:20"
      "title" = "Oops! Our provisioning on the CentOS machine failed. Lets fix it (Fuck you, Python 2)"
    },
    {
      "time" = "00:37:00"
    ...
    {
      "time" = "00:14:00"
      "title" = "Adding the file state module to our first state: creating a directory and writing a file"
    },
    {
      "time" = "00:26:45"
