episode "Klustered (Part III)" {
  draft = false
  show = "klustered"
  published_at = "2021-03-04T17:00:00Z"
  youtube_id = "Ps2CQm6_aZU"
  youtube_category = 24
  links = [
    "twitter.com/rothgar",
    "twitter.com/IanColdwater).",
    "gitlab.com/rawkode/klustered",
    ...
    "youtu.be/_BFbrrXKMOM",
    "youtu.be/JvgpDTx1AZ0",
    "youtu.be/_GZ8UuEZxbY",
    "youtu.be/_BFbrrXKMOM",
    "youtu.be/z0Lf303tKtQ",
    "youtu.be/-k5y2C6HNa0",
    "youtu.be/FClIbQ8hdxY",
    "twitter.com/rawkode",
    "rawkode.live",
    "rawkode.live/chat",
    "twitter.com/mhausenblas",
    "github.com/mhausenblas",
    "mhausenblas.info/",
    "kubernetes.io/",
  ...
  chapters = [
    ...
    {
      "time" = "00:48:00"
      "title" = "Kluster 006 by SIG Honk (Ian Coldwater, Duffie Cooley, Rory McCune, Brad Geesaman)"
    }
  ]
}
