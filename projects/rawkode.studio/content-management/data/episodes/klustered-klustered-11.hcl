episode "klustered-klustered-11" {
  title = "Klustered #11"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-05-06T16:35:00Z"
  youtube_id = "ysfUgYs4YYY"
  youtube_category = 24
  links = [
    ...
    "https://twitter.com/thomrstrom",
    "https://github.com/tstromberg",
    "https://twitter.com/krisnova",
    "https://github.com/kris-nova",
    "https://nivenly.com/",
    "https://kubernetes.io/",
  ...
  chapter "Cluster by Kris Nova" {
    time = "00:06:30"
  }

  chapter "Cluster by Thomas Stromberg" {
    time = "00:40:00"
  }
}
