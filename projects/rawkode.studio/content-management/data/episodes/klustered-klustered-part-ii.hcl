episode "klustered-klustered-part-ii" {
  title = "Klustered (Part II)"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-02-25T12:00:00Z"
  youtube_id = "JzGv36Pcq3g"
  youtube_category = 24
  links = [
    ...
    "https://github.com/thebsdbox",
    "https://thebsdbox.co.uk/",
    "https://kubernetes.io/",
  ...
  chapter "Debugging the Wrong / Working Kluster (Oops)" {
    time = "00:06:45"
  }

  chapter "Kluster 004 - Broken by Jason DeTiberus (@detiber)" {
    time = "00:17:55"
  }

  chapter "Kluster 005 - Broken by Walid Shaari (@walidshaari)" {
    time = "00:57:20"
  }
}
