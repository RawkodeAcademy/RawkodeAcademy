episode "klustered-klustered-10" {
  title = "Klustered #10"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-05-06T12:30:00Z"
  ...
  links = [
    ...
    "https://github.com/walidshaari",
    "https://twitter.com/noelgeorgi",
    "https://github.com/frezbo",
    "https://resume.frezbo.dev/",
    "https://kubernetes.io/",
  ...
  chapter "Cluster by Walid Shaari" {
    time = "00:03:40"
  }

  chapter "Cluster by Noel Georgi" {
    time = "00:29:40"
  }

  chapter "Cluster by Rawkode" {
    time = "00:02:00"
  }
}
