episode "Klustered #17" {
  ...
  show = "klustered"
  live = true
  scheduled_for = "2021-08-19T16:30:00Z"
  ...
  links = [
    ...
    "https://twitter.com/szucsitg",
    "https://github.com/szucsitg",
    "https://twitter.com/kassah",
    "https://github.com/kassah",
    "https://kubernetes.io/",
  ...
  chapter "Cluster by Ádám Szücs-Mátyás" {
    time = "00:06:45"
  }

  chapter "Cluster by William Lightning" {
    time = "00:39:15"
  }
}
