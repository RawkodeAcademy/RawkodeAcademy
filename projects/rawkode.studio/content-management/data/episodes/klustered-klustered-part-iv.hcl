episode "klustered-klustered-part-iv" {
  title = "Klustered (Part IV)"
  draft = false
  show = "klustered"
  live = true
  scheduled_for = "2021-03-11T17:00:00Z"
  ...
  chapter "Cluster 007 by Dan Pop and Matt Moore" {
    time = "00:03:00"
  }

  chapter "Cluster 008 by Akos Veres" {
    time = "00:59:00"
  }
}
