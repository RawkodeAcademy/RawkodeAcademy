				...
				<div id="accordion-flush" data-accordion="collapse"
					...
					<h2 id="accordion-flush-heading-1">
						<button type="button"
							...
							<span>Do you offer monthly partnerships?</span>
					...
					<div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
						<div class="py-5 border-b border-gray-200 dark:border-gray-700">
							<p class="mb-2 text-gray-500 dark:text-gray-400">No. It's very difficult for us to work together in such a
								short amount of time. In-order to see real results from our collaboration, it requires a long-term
								commitment from us both. I want to help you, I can't do that in 30 days.</p>
						</div>
					</div>
					<h2 id="accordion-flush-heading-2">
						<button type="button"
							...
							<span>Do we need to pay a year upfront?</span>
					...
					<div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
						<div class="py-5 border-b border-gray-200 dark:border-gray-700">
							<p class="mb-2 text-gray-500 dark:text-gray-400">On the lower-tiers, yes. If you wish to join us on the
								Blend or Malt level, we're happy to discuss.</p>
						</div>
					</div>
					<h2 id="accordion-flush-heading-3">
						<button type="button"
							...
							<span>Will we get 10,000 leads?</span>
							<svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor" viewBox="0 0 20 20"
								xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd"
									d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
					...
					<div id="accordion-flush-body-4" class="hidden" aria-labelledby="accordion-flush-heading-4">
						<div class="py-5 border-b border-gray-200 dark:border-gray-700">
							<p class="mb-2 text-gray-500 dark:text-gray-400">That's OK! <a class="text-primary"
									href="/organizations/lets-chat">Book some
									time</a> for us to chat.
							</p>
						</div>
					</div>
				</div>
