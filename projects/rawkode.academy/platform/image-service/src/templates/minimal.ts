...
export const template: Template = {
  ...
  render(payload) {
    ...
    return html(
      `<div style="display: flex; width: 1200px; height: 630px; background-color: white; font-family: Montserrat;">
        <div style="flex: 1; display: flex; flex-direction: column; padding: 80px; justify-content: space-between;">
          <!-- Logo -->
        ...
        ${payload.image ?
          `<div style="flex: 1; background-image: url('${payload.image}'); background-size: cover; background-position: center;"></div>`
          :
          `<div style="flex: 1; background: linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%); display: flex; align-items: center; justify-content: center;">
            <div style="width: 60%; height: 60%; border: 2px solid #e5e7eb; border-radius: 4px; display: flex; align-items: center; justify-content: center;">
              <div style="font-size: 18px; color: #9ca3af; text-align: center; display: flex; flex-direction: column; align-items: center;">
                <div style="display: flex; margin-bottom: 16px;">No image provided</div>
                <div style="width: 40px; height: 40px; border: 2px solid #d1d5db; border-radius: 50%; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
