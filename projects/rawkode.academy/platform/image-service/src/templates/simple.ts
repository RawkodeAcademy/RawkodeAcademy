...
export const template: Template = {
  ...
  render(payload) {
    ...
    return html(`
      <div style="display: flex; flex-direction: column; width: 1200px; height: 630px; background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); font-family: Inter;">
        <div style="display: flex; padding: 60px; flex-direction: column; height: 100%;">
          ...
          <div style="display: flex; flex-direction: column; flex: 1; justify-content: center;">
            <h1 style="font-size: 64px; font-weight: 700; color: #1a202c; margin: 0 0 24px 0; line-height: 1.2; max-width: 800px;">
              ${payload.text}
            </h1>
            <p style="font-size: 24px; color: #4a5568; margin: 0; line-height: 1.5;">
              Rawkode Academy
            </p>
          </div>

          <div style="display: flex; margin-top: 40px; font-size: 16px; color: #718096;">
            rawkode.academy
          </div>
        </div>
      </div>
