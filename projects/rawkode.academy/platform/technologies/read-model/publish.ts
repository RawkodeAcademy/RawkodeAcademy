...
await $`bunx wgc subgraph publish ${serviceName} --namespace production --schema ./read-model/schema.gql --routing-url https://${serviceName}-read-458678766461.europe-west2.run.app`;
