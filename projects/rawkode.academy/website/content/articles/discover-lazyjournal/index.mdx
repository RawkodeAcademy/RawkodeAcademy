---
title: "Lazyjournal: A Comprehensive Log Viewer for Cloud Native Environments"
description: "Lazyjournal is a terminal user interface log viewer that aggregates logs from various sources, providing a unified interface for developers and system administrators."
...
import ThemeAwareImage from '@/components/common/ThemeAwareImage.vue';
...
<ThemeAwareImage
  client:load
  lightSrc={screenshotLight.src}
  darkSrc={screenshotDark.src}
