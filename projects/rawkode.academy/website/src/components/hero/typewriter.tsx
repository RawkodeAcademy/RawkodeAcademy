      ...
      <div className="grid px-4 py-12 mx-auto lg:gap-8 xl:gap-0 lg:py-24 lg:grid-cols-12 max-w-7xl">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-6 py-3 mr-3 text-base font-medium text-center rounded-lg text-white bg-linear-to-br from-primary to-secondary hover:from-secondary hover:to-primary focus:outline-none focus:ring-2 focus:ring-primary/30 focus:ring-offset-2 transition-all duration-fast shadow-sm hover:shadow-md"
          >
