...
export const Tip: Story = {
  args: {
    ...
    children: (
      <p>
        This is a helpful tip! You can use keyboard shortcuts like{" "}
...
export const Caution: Story = {
  args: {
    ...
    children: (
      <p>
        Be careful when running this command. Make sure you have backed up your
  ...
  args: {
    ...
    children: (
      <p>
        ...
        This action is irreversible! Once deleted, the data cannot be recovered.
      </p>
    ),
  },
};
...
export const Info: Story = {
  args: {
    ...
    children: (
      <div>
        <p>
          For more information about this feature, check out our{" "}
