...
<template>
	<aside
		class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full md:translate-x-0 
		...
		<div class="overflow-y-auto py-5 px-4 h-full">
			...
			<form action="/search" method="GET" class="md:hidden mb-4 relative">
				...
				<div class="relative">
					...
					>
						<svg
							class="w-5 h-5 text-primary/70 dark:text-primary/70"
							fill="currentColor"
							viewBox="0 0 20 20"
					...
					<input
						...
						name="q"
						id="sidebar-search"
						class="bg-white/80 dark:bg-black/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg 
			...
			<div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-800">
				<div class="text-xs font-semibold leading-6 px-2 mb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
					For OSS Maintainers
				</div>
				<ul class="space-y-1.5">
			...
			<div class="pt-4 mt-4 border-t border-gray-200 dark:border-gray-800"> 
				<div class="text-xs font-semibold leading-6 px-2 mb-2 bg-clip-text text-transparent bg-gradient-to-r from-primary to-tertiary">
					For Organizations
				</div>
				<ul class="space-y-1.5">
