...
const sampleTestimonials = [
  {
    quote: "The cloud native courses at Rawkode Academy transformed my career. The hands-on approach and expert guidance made complex concepts easy to understand.",
    author: {
      name: "Sarah Johnson",
  ...
  {
    quote: "I've been following Rawkode for years. The quality of content and community support is unmatched. Highly recommend for anyone serious about cloud technologies.",
    author: {
      name: "Michael Chen",
  ...
  {
    quote: "From beginner to advanced topics, Rawkode Academy covers it all. The real-world examples and practical exercises helped me implement solutions at scale.",
    author: {
...
export const WithoutLinks: Story = {
  args: {
    ...
    props: {
      testimonials: [
        {
          quote: "An amazing learning experience that helped me master Kubernetes and cloud native practices.",
          author: {
            name: "Alex Thompson",
        ...
        {
          quote: "The community is incredibly supportive and the content is always cutting-edge.",
          author: {
