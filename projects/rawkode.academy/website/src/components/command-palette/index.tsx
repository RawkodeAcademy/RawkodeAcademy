...
const externalNavigationItems: NavigationItem[] = [
  { id: 'github', title: 'GitHub', href: 'https://github.com/rawkode', category: 'External', description: 'Visit our GitHub' },
  { id: 'gitlab-issues', title: 'Report Issue', href: 'https://gitlab.com/rawkode/rawkode-academy/-/issues', category: 'External', description: 'Report a bug or request a feature' },
  { id: 'gitlab-repo', title: 'Source Code', href: 'https://gitlab.com/rawkode/rawkode-academy', category: 'External', description: 'View the source code' },
];
...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  const [navigationItems, setNavigationItems] = useState<NavigationItem[]>(externalNavigationItems);
          ...
          <div className="command-palette-header">
            <div style={{ position: 'relative', width: '100%', display: 'flex', alignItems: 'center' }}>
              <svg
                ...
                stroke="currentColor"
                viewBox="0 0 24 24"
                style={{ position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', zIndex: 1, pointerEvents: 'none' }}
              >
                <path
                  strokeLinecap="round"
              ...
              <Command.Input
                ...
                style={{ paddingLeft: '52px', paddingRight: '70px', width: '100%' }}
              />
              <kbd 
