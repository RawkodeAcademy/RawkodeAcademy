		...
		<section className="bg-white dark:bg-black">
			<div className="grid px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
				<div className="mr-auto place-self-center lg:col-span-7">
					<h1
						className="mb-4 text-4xl font-semibold tracking-tight leading-none md:text-5xl xl:text-6xl text-black dark:text-white">
						<TypeAnimation
							className='bg-gradient-to-br from-primary to-secondary bg-clip-text text-transparent'
							sequence={shuffle(props.rotatedPrefixes).reduce<Array<string | number>>((acc, prefix) => [...acc, prefix, 1250], [])}
							wrapper="span"
