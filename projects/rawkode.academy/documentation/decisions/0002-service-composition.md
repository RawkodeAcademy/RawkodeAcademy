...
* All services **MUST** be able to function in isolocation for local development and test
* All services **MUST** expose a separate read and write model
* All services **SHOULD** use GraphQL for their read model
...
Grafbase provides GraphQL Federation for all services that require it. Any service that provides a read model must register their schema with the Grafbase Gateway.
