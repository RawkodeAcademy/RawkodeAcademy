...
## M1 — Core Live Path
- [ ] RKS-M1-MED-01 — Producer simulcast publisher — Assignee: — PR: — Done:
- [ ] RKS-M1-FE-01 — Viewer WebRTC player (Auto) — Assignee: — PR: — Done:
- [ ] RKS-M1-FE-02 — Manual quality selector — Assignee: — PR: — Done:
- [ ] RKS-M1-FE-03 — Producer UI shell — Assignee: — PR: — Done:
- [ ] RKS-M1-FE-04 — Dynamic grid layer — Assignee: — PR: — Done:
- [ ] RKS-M1-FE-05 — Transitions (blur/crossfade/wipe) — Assignee: — PR: — Done:
- [ ] RKS-M1-CP-03 — DataChannel broadcaster — Assignee: — PR: — Done:

## M2 — Auth + Interactivity
- [ ] RKS-M2-INF-01 — atproto OAuth integration — Assignee: — PR: — Done:
- [ ] RKS-M2-MED-01 — Guest publish + return — Assignee: — PR: — Done:
...
## M3 — Recording
- [ ] RKS-M3-REC-01 — Local ISO capture — Assignee: — PR: — Done:
- [ ] RKS-M3-REC-02 — Progressive multipart upload to R2 — Assignee: — PR: — Done:
